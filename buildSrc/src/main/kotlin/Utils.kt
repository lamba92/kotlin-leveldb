...
fun getLevelDBBuildLink(version: String) = "https://github.com/lamba92/leveldb-builds/releases/download/$version/leveldb.zip"
...
fun Project.registerExtractLevelDbTask(
    ...
    isRelease: Boolean =
        project.properties["leveldb.release"]
            ?.let { it as? String }
